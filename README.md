...
```
python inference-scripts/inference-with-roi.py --config nanodet-plus-m_416_custom.yml --param ncnn-model\nanodet.ncnn.param --bin ncnn-model\nanodet.ncnn.bin --rtsp "rtsps://admin:Kion%402024@10.102.10.230:554/video/live?channel=1&subtype=1" --violation_duration 5.0 --display
```
